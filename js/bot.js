$(function() {
	...
	.fbMessenger('message', 'bot', 'Hello, I\'m <b>Mohan</b> - Deep Learning Consultant at Activation Functions', { timestamp: now, delay: 1500 })
	//.fbMessenger('message', 'bot', 'Rolling beans at <b>Walmart Labs</b> 😆', { timestamp: now, delay: 1200 })

	.fbMessenger('showGenericTemplate', [
	{
	imageUrl: 'img/hello.gif',
	title: '',
	subtitle: '',
	buttons: []
	}
	...
	.fbMessenger('showQuickReplies', [
		...
		'<a href="https://medium.com/@mohankumar_9393" target="_blank">Writing</a>',
